...
#        ttf95_s = telemetry_df[telemetry_df[""]]
    ...
    def corner(self, corner_df: pd.DataFrame) -> Corner:
        ...
        f = 0.4
        smoothness_factor = (f - 1) * TelemetryCalculator.parameter_smoothness(corner_df, "STEERANGLE") + f * TelemetryCalculator.parameter_smoothness(corner_df, "ROTY")# + 0.2 * self.parameter_smoothness(corner_df, "THROTTLE")
